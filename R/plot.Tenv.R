...
#' @param axes Logical value. Specify whether the axes should be drawn.
#' @param ask Logical. If TRUE (default), the user is prompted before the second plot (if exists).
#' @param ... Other parameters to be passed through to plotting functions.
#'
#' @seealso \code{\link{TRR.fit}, \link{TPR.fit}, \link{graphics::image}}
#'
#' @examples
#'  data("bat")
#'  x <- bat$x
