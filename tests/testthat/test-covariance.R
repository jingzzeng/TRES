...
test_that("Covariance matrix", {
  ...
  expect_equal(fit_1d1$test_out_list[[1]][[1]]$XDiff_list[[1]], 0.00030190)
  expect_equal(drop(fit_1d1$test_out_list[[1]][[1]]$FDiff_list[[1]]), 0.00157581)
  expect_equal(fit_1d1$test_out_list[[1]][[1]]$Q_list[[1]], 1.85000000)
  expect_equal(drop(fit_1d1$test_out_list[[1]][[1]]$Cval_list[[1]]), -11.02150136)
